...
but1 = tk.Button(tab1, text="Level 1", width=5, height=2, borderwidth=15, font=("Helvetica", 13), command=lambda: one())
but1.configure(fg="white", bg="#000000")
but1.place(x=650, y=100)

but2 = tk.Button(tab1, text="Level 2", width=5, height=2, borderwidth=15, font=("Helvetica", 13), command=lambda: two())
but2.configure(fg="white", bg="#000000")
but2.place(x=650, y=220)

but3 = tk.Button(tab1, text="Level 3", width=5, height=2, borderwidth=15, font=("Helvetica", 13), command=lambda: three())
but3.configure(fg="white", bg="#000000")
but3.place(x=650, y=340)

but4 = tk.Button(tab1, text="Level 4", width=5, height=2, borderwidth=15, font=("Helvetica", 13), command=lambda: four())
but4.configure(fg="white", bg="#000000")
but4.place(x=650, y=460)

but5 = tk.Button(tab1, text="Level 5", width=5, height=2, borderwidth=15, font=("Helvetica", 13),command=lambda: five())
but5.configure(fg="white", bg="#000000")
but5.place(x=650, y=580)
...
it comprises of 5 levels which gets more difficulty every level you go. so level 1 being very easy, level two being 
easy, level 3 being hard, level 4; hard and level 5; very hard. So all level are accessible and its  
just for you to have fun and try any question you think you can solve, knock yourself out.
